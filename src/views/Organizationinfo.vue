<template>
  <div>
    ...
    <h1 class="display-1">Сведения об организации (Реквизиты компании)</h1>
    ...
    <div class="contractor-info">
      <v-row>
        <v-col>
          ...
          <h3>Cокращенное наименование организации</h3>
          <v-text-field v-model="contractor.short_name" placeholder="не указан" onfocus="this.placeholder=''" onblur="this.placeholder='не указан'" :disabled="!editable"></v-text-field>
